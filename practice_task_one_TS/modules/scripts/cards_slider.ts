function cardsSlider(event: Event): void {
    let service_button: HTMLElement | null = document.getElementById("service-button");
    let integration_button: HTMLElement | null = document.getElementById("integration-button");
